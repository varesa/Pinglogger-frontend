...
<html>
	...
	function renderGraph($sizex, $sizey, $fin) {
	    ...
	    $fout = "temp.jpg";
	    $gnuplotcmd = 'set xdata time;set timefmt "%s"; set terminal jpeg size 2000,600; set output "' . $fout . '"; set xzeroaxis lt 20; set yrange [-10:]; plot "temp.log" using 1:2:3 lc rgb variable';
